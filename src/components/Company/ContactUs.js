    ...
    <>
      ...
      <Container>
        ...
        <Row style={{ padding: "0 50px" }}>
          <Col md={10} className="pt-5">
            <h1 style={{ fontSize: "35px", color: "black" }}>Contact Us</h1>
        ...
        <Row style={{ padding: "0 50px" }}>
          <Col md={10} className="pt-5">
            <h1 style={{ fontSize: "35px", color: "black" }}>Address</h1>
            <p style={{ fontSize: "20px" }}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Suspendisse varius enim in eros elementum tristique. Duis cursus,
              mi quis viverra ornare, eros dolor interdum nulla, ut commodo quam
        ...
        <Row style={{ padding: "0 50px" }}>
          <Col md={10} className="pt-5">
            <h1 style={{ fontSize: "35px", color: "black" }}>Email</h1>
            <p style={{ fontSize: "20px" }}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Suspendisse varius enim in eros elementum tristique. Duis cursus,
              mi quis viverra ornare, eros dolor interdum nulla, ut commodo quam
        ...
        <Row style={{ padding: "0 50px" }}>
          <Col md={10} className="pt-5">
            <h1 style={{ fontSize: "35px", color: "black" }}>Phone</h1>
            <p style={{ fontSize: "20px" }}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Suspendisse varius enim in eros elementum tristique. Duis cursus,
              mi quis viverra ornare, eros dolor interdum nulla, ut commodo quam
