...
// function DisplayCar({ colorChange, toogleChange, auctionProp }) {
...
//     setRegisterEnded(auctionProp ? auctionProp.registerEndDate : null);

//     //set dates for ongoing auction end date
//     setOnGoingAuctionEnd(auctionProp ? auctionProp.auctionEndDate : null);
//     setStartAuction(auctionProp ? auctionProp.auctionStartDate : null);

//     //set location for map
//     setLocation({
//       name: "Property Location",
//       lat: auctionProp
//         ? auctionProp.property.details.property_address.latitude
//         : null,
//       lng: auctionProp
//         ? auctionProp.property.details.property_address.longitude
//         : null,
//     });
...
//     let topBidders = [];
//     if (auctionData) {
//       for (let i = 0; i < auctionProp.highestBidders.length; i++) {
//         topBidders = [...topBidders, auctionProp.highestBidders[i]];
//       }
//       setTopBid(topBidders.reverse());
//     } else if (propertyProp) {
//       if (propertyProp.highestBidders) {
//         for (let i = 0; i < propertyProp.highestBidders.length; i++) {
//           topBidders = [...topBidders, propertyProp.highestBidders[i]];
//         }
//         setTopBid(topBidders.reverse());
//       } else {
//         setTopBid([]);
...
//   return (
//     <>
//       {location && auctionProp && startAuction && (
//         <>
//           <div
...
//                       </GoogleMap>
//                       <p>{auctionProp.details.property_address}</p>
//                     </Modal.Body>
//                   </Modal>
//                 </div>
//               )}
...
//                       <tr>
//                         <td>Make</td>
//                         {auctionProp.details.make ? (
//                           <td>{auctionProp.details.make}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Model</td>
//                         {auctionProp.details.model ? (
//                           <td>{auctionProp.details.model}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Year</td>
//                         {auctionProp.details.year ? (
//                           <td>{auctionProp.details.year}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Color</td>
//                         {auctionProp.details.color ? (
//                           <td>{auctionProp.details.color}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
...
//                       <tr>
//                         <td>Mileage</td>
//                         {auctionProp.details.mileage ? (
//                           <td>{auctionProp.details.mileage}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Transmission</td>
//                         {auctionProp.details.transmission ? (
//                           <td>{auctionProp.details.transmission}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>VIN</td>
//                         {auctionProp.details.VIN ? (
//                           <td>{auctionProp.details.VIN}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Car Type</td>
//                         {auctionProp.details.car_type ? (
//                           <td>{auctionProp.details.car_type}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Fuel Type</td>
//                         {auctionProp.details.fuel_type ? (
//                           <td>{auctionProp.details.fuel_type}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Condition</td>
//                         {auctionProp.details.condition ? (
//                           <td>{auctionProp.details.condition}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Engine</td>
//                         {auctionProp.details.engine ? (
//                           <td>{auctionProp.details.engine}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
//                       <tr>
//                         <td>Power</td>
//                         {auctionProp.details.power ? (
//                           <td>{auctionProp.details.power}</td>
//                         ) : (
//                           <td>N/A</td>
//                         )}
//                       </tr>
