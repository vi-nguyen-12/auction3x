    ...
    <>
      ...
      <Modal.Body>
        <form>
          <div className="term">
            <ul>
              <h3 style={{ fontWeight: "bold", color: "black" }}>1. Terms and Conditions</h3>
              ...
              <li className="buyer-agree">1.4. The Auction 10X team is not a real estate broker.</li>
              <li className="buyer-agree">1.5. The Auction 10X team is not a real estate investor.</li>
              <li className="buyer-agree">1.6. The Auction 10X team is not a real estate agent.</li>
              <li className="buyer-agree">1.7. The Auction 10X team is not a real estate developer.</li>
              <li className="buyer-agree">1.8. The Auction 10X team is not a real estate developer.</li>
              <li className="buyer-agree">1.9. The Auction 10X team is not a real estate developer.</li>
            </ul>
            <input
            ...
            />
            <label style={{ color: "black" }}>I agree to the terms and conditions</label>
          </div>
        </form>
      </Modal.Body>
