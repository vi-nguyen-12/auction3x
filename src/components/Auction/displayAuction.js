              ...
              >
                ...
                <Modal.Body>
                  <Carousel
                    ...
                    {...ImgSettings}
                  >
                    {auctionProperty.images.map((item) => (
                      <Wrap>
                        <a>
                          <img
                            style={{ height: "50vh" }}
              ...
              <Modal size="lg" show={showVideos} onHide={toggleVids} centered>
                ...
                <Modal.Body style={{ height: "500px" }}>
                  <Carousel
                    ...
                    {...settings}
                  >
                    {auctionProperty.videos.map((item) => (
                      <Wrap>
                        <a>
                          <video
                            style={{
          ...
          <div style={{ padding: "35px" }}>
            ...
            <tr>
              ...
              >
                ...
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.structure.stories} Stories
                </span>
              </td>
            </tr>
            <tr>
              ...
              >
                Property Type:{" "}
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.parcel.county_land_use_description}
                </span>
              </td>
              <td
                style={{
            ...
            <tr>
              ...
              >
                Zoning:{" "}
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.parcel.zoning}
                </span>
              </td>
            </tr>
            <tr>
              ...
              >
                Building Class:{" "}
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.structure.quality}
                </span>
              </td>
              <td
                style={{
              ...
              >
                Parking:{" "}
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.structure.parking_type}
                </span>
              </td>
            </tr>
            <tr>
              ...
              >
                ...
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.structure.year_built}
                </span>
              </td>
              <td
                style={{
              ...
              >
                Frontage:
                <span style={{ fontWeight: "bold" }}>
                  {auctionProperty.details.parcel.frontage_ft}
                </span>
              </td>
            </tr>
            <tr>
          ...
          <div style={{ padding: "35px" }}>
            ...
            <tr>
              <td>
                ...
                1957 and located in West Milwaukee, Wisconsin, this property is
                a single-story, ‡4,856-SF office most recently used as a medical
                ...
                strategic marketing/lease-up plan. Today, Milwaukee is one of
                the most ethnically and culturally diverse cities in the United
              ...
              <td>
                ...
                the Wisconsin Center, American Family Field, The Hop (streetcar
                ...
                Arena. Fiserv Forum opened in late 2018 and hosts sporting
                events and concerts. Since 1968, Milwaukee has been home to
                Summerfest, one of the largest music festivals in the world.
                With regard to education, Milwaukee is home to UW-Milwaukee,
                Marquette University, MSOE, and several other universities and
                colleges. The city is home to two major professional sports
                teams, the Bucks and Brewers. It is home to several Fortune 500
                companies, including Northwestern Mutual, WE Energy Group,
                Rockwell Automation, and Harley-Davidson. Property tours are
                available by appointment only. Please contact Alexander Reid to
                schedule at 847-791-2420 or alexander@reidgroup.house.
              </td>
            </tr>
          </div>
        </div>
